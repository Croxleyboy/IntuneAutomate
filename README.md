...
For an overview of IntuneAutomate features take a look at the demonstration! 
...
This solution is Microsoft-focused and runs entirely within your own tenant, leveraging your existing security posture — No external subscriptions required. PLUS you get to shape and change the solution to your our standards - Use it as a template or use the community updates as they are released. 
...
As a FREE Community tool new features, bug fixes and updates will be made available over time. BUT if you would like to be a part of this tool I'd love to get your ideas and helpful design and configuration Updates. Please help shape the future updates and contribute to the solution.
...
- UTCM Enhancements and added Resource Types as Microsoft moves to GA
